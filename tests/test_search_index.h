...
template<typename T>
int search_disk_index(std::string index_prefix_path, std::string str_metric, std::string data_type, std::string query_bin, 
...
extern "C" {
  ...
  inline int seearch_index_float(std::string index_prefix_path, std::string str_metric, std::string data_type, std::string query_bin, 
